        ...
        switch (this.type) {
            ...
            case this.TYPE_CHEST:
                ...
                switch (this.consumableData.c) {
                    case 1:
                        this.consumableData.v = this.consumable.gamebuffs.getRngBuff();
                        break;
                    case 2:
                        this.consumableData.v = this.consumable.getHealthModifier();
                        break;
                    case 3:
                        this.consumableData.v = this.consumable.getFocusModifier();
                        break;
                }
