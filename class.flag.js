...
game_flag.prototype.targetSlot = null;
/*function(slot)
{
...
game_flag.prototype.slotFlag = function(player) {
    ...
    if (this.name == clientFlag.target) //player.carryingFlag.targetSlot)
    {
        ...
        if (this.config.server) {
            ...
            var flg1 = this.config._.find(roomFlags, { "name": clientFlag.name });
            cd.flag = flg1; //clientFlag; // TODO: <- should be flag class NOT clientCooldown flag
            console.log('* cf.flag', flg1);
