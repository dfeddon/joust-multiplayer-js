        ...
        copy:
        {
            main:
            {
                ...
                [
                    ...
                    // { src: ['./dist/server/app.js'], dest: '../wingdom-server-dist/' },
                    // { src: ['./dist/server/game.server.js'], dest: '../wingdom-server-dist/' },
                    // { src: ['./dist/server/game.core.js'], dest: '../wingdom-server-dist/' },
                    // { src: ['./dist/server/class.globals.js'], dest: '../wingdom-server-dist/' },
                    // { src: ['./dist/server/singleton.assets.js'], dest: '../wingdom-server-dist/' },
                    // { src: ['./dist/server/class.getplayers.js'], dest: '../wingdom-server-dist/' },
                    { src: ['./egyptian_set.js'], dest: '../wingdom-server-dist/' },
                    // { src: ['./dist/server/class.player.js'], dest: '../wingdom-server-dist/' },
                    // { src: ['./dist/server/class.flag.js'], dest: '../wingdom-server-dist/' },
                    // { src: ['./dist/server/class.platform.js'], dest: '../wingdom-server-dist/' },
                    // { src: ['./dist/server/class.event.js'], dest: '../wingdom-server-dist/' },
                    // { src: ['./dist/server/class.chest.js'], dest: '../wingdom-server-dist/' },
                    // { src: ['./dist/server/class.toast.js'], dest: '../wingdom-server-dist/' },
                    // { src: ['./dist/server/class.spritesheet.js'], dest: '../wingdom-server-dist/' },
