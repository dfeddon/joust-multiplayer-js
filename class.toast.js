...
game_toast.prototype.show = function(data)
{
  ...
  */
  ...
  {
    case "takeFlag":
      this.toast.innerHTML = "<font color='" + data.playerTeam + "'<b>" + data.playerName + "</b></font> siezed the <font color='#fff'><b>"+ data.flagName + "</b></font>!<br>Rally down to <font color='yellow'><b>"+ data.targetSlot + "</b></font>!";
    break;
