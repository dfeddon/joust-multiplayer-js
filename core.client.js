...
//         if (child.id)
//         {
//             if (child.id == id) {console.log("* got it!", child);return child;}
//             else this.getNodeChildById(child, id);
//         }
//     }
// }
...
core_client.prototype.updateTerritory = function() {
    ...
    function slotToColor(s) {
        ...
        if (s == 'mid')
            return ['white', 'black'];
        if (s === 1)
            return ['rgba(155, 0, 0, 0.9)', 'white'];
        if (s == 2)
            return ['rgba(70, 142, 229, 0.9)', 'white'];
    }
    ...
    var redIndex = slotToIndex(red.sourceSlot);
    var blueIndex = slotToIndex(blue.sourceSlot);
    ...
    document.getElementById('flagRedBase').style.backgroundColor = slotToColor(slots[0])[0];
    document.getElementById('flagRedtxt').style.color = slotToColor(slots[0])[1];
    document.getElementById('flagRedtxt').style.animationPlayState = "paused";
    document.getElementById('flag1').style.backgroundColor = slotToColor(slots[1])[0];
    document.getElementById('flag1txt').style.color = slotToColor(slots[1])[1];
    document.getElementById('flag1txt').style.animationPlayState = "paused";
    document.getElementById('flag2').style.backgroundColor = slotToColor(slots[2])[0];
    document.getElementById('flag2txt').style.color = slotToColor(slots[2])[1];
    document.getElementById('flag2txt').style.animationPlayState = "paused";
    document.getElementById('flag3').style.backgroundColor = slotToColor(slots[3])[0];
    document.getElementById('flag3txt').style.color = slotToColor(slots[3])[1];
    document.getElementById('flag3txt').style.animationPlayState = "paused";
    document.getElementById('flag4').style.backgroundColor = slotToColor(slots[4])[0];
    document.getElementById('flag4txt').style.color = slotToColor(slots[4])[1];
    document.getElementById('flag4txt').style.animationPlayState = "paused";
    document.getElementById('flag5').style.backgroundColor = slotToColor(slots[5])[0];
    document.getElementById('flag5txt').style.color = slotToColor(slots[5])[1];
    document.getElementById('flag5txt').style.animationPlayState = "paused";
    document.getElementById('flagMid').style.backgroundColor = slotToColor(slots[6])[0];
    document.getElementById('flagMidtxt').style.color = slotToColor(slots[6])[1];
    document.getElementById('flagMidtxt').style.animationPlayState = "paused";
    document.getElementById('flag6').style.backgroundColor = slotToColor(slots[7])[0];
    document.getElementById('flag6txt').style.color = slotToColor(slots[7])[1];
    document.getElementById('flag6txt').style.animationPlayState = "paused";
    document.getElementById('flag7').style.backgroundColor = slotToColor(slots[8])[0];
    document.getElementById('flag7txt').style.color = slotToColor(slots[8])[1];
    document.getElementById('flag7txt').style.animationPlayState = "paused";
    document.getElementById('flag8').style.backgroundColor = slotToColor(slots[9])[0];
    document.getElementById('flag8txt').style.color = slotToColor(slots[9])[1];
    document.getElementById('flag8txt').style.animationPlayState = "paused";
    document.getElementById('flag9').style.backgroundColor = slotToColor(slots[10])[0];
    document.getElementById('flag9txt').style.color = slotToColor(slots[10])[1];
    document.getElementById('flag9txt').style.animationPlayState = "paused";
    document.getElementById('flag10').style.backgroundColor = slotToColor(slots[11])[0];
    document.getElementById('flag10txt').style.color = slotToColor(slots[11])[1];
    document.getElementById('flag10txt').style.animationPlayState = "paused";
    document.getElementById('flagBlueBase').style.backgroundColor = slotToColor(slots[12])[0];
    document.getElementById('flagBluetxt').style.color = slotToColor(slots[12])[1];
    document.getElementById('flagBluetxt').style.animationPlayState = "paused";
